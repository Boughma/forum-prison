...
<div class="container">
    ...
    <div class="actions">
        ...
        <a href="sent.php">📤 Messages envoyés</a>
        <form method="POST" action="delete_all_received.php" onsubmit="return confirm('Supprimer TOUS les messages reçus ?');">
                ...
                <?php foreach ($messages as $msg): ?>
                    <tr>
                        ...
                        <td>
                            ...
                            <?php else: ?>
                                <a href="/forum-prison/profil.php?id=<?= $msg['sender_id'] ?>" style="color:#55ffff;">
                        ...
                        <td>
                            <form method="POST" action="delete_received.php" onsubmit="return confirm('Supprimer ce message ?');">
