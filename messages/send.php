...
if (!$userData) {
    header('Location: inbox.php?error=user_not_found');
    exit;
}
...
<div class="container">
    <div class="message-header">
        ...
        <p style="margin-top:10px;">Destinataire : <strong><?= htmlspecialchars($userData['username']) ?></strong></p>
    </div>
    ...
    <div style="margin-top:20px; text-align:center;">
        ...
        <?php else: ?>
            <a href="new_message.php" class="button">🔙 Retour choisir un destinataire</a>
        <?php endif; ?>
    </div>
</div>
