...
? 'uploads/avatars/' . basename($targetUser['avatar'])
...
<?php if (!$isVisitorMode && !empty($targetUser['avatar'])): ?>
    <form method="post" action="delete_avatar.php" onsubmit="return confirm('Supprimer votre photo de profil ?')" style="margin-top:10px;">
...
<?php endif; ?>
    ...
    <a href="messages/send.php?id=<?= $targetUser['id'] ?>&from_profile=<?= $targetUser['id'] ?>" class="btn-neon" style="display:inline-block; margin-top:15px;">
